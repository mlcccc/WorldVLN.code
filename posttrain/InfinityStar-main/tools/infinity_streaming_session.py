...
class InfinityStreamingSession:
    def __init__(
        ...
        *,
        ...
        # RoPE "real_sid" for GT observation cache.
        # Use 0 to make it a stable "prefix-like" memory; large values can
        # misalign phases and degrade attention matching across queries/keys.
        gt_obs_rope_real_sid: int = 0,
    ):
        self.args = args
        ...
        *,
        ...
        with torch.amp.autocast("cuda", dtype=model_dtype):
            return self.infinity.autoregressive_infer(
                ...
                extra_ref_text_scale_inds=[self.gt_obs_cache_key],
            )
