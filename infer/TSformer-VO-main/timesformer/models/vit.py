...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        # Optimized Attention with PyTorch 2.0 SDPA (Flash Attention)
...
class VisionTransformer(nn.Module):
    ...
    def forward_features(self, x):
        ...
        ## Time Embeddings
        if self.attention_type != 'space_only':
            # x is shaped as (B*T, 1+N, D) after PatchEmbed + cls + pos.
            # We need one cls token per video, so take indices 0, T, 2T, ...
